...
$base_url ="../../Oreju";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/upload/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = './upload/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$access_keys = array('myPrivateKey','tinhvan');
