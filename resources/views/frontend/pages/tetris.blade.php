      ...
      <div class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="box">
              ...
              <div class="tetris-body example-base">
                <center>
                  <div class="box">
                    <canvas id="canvas0" width="250" height="500"></canvas>
                    <canvas id="canvas1" width="250" height="500"></canvas>
                  </div>
                  <input type="button" id="restartButton" class="btn btn-primary"value="Restart Game" />
                </center>
              </div>
            </div>
          </div>
            ...
            <script>
              ...
              function start() {
                var tetrisRef = new Firebase('https://vsn0luo5bgf.firebaseio-demo.com/');
